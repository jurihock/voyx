...
public:
  ...
  SweepSource(std::pair<voyx_t, voyx_t> frequencies, voyx_t duration, voyx_t samplerate, size_t framesize, size_t buffersize);
  SweepSource(voyx_t amplitude, std::pair<voyx_t, voyx_t> frequencies, voyx_t duration, voyx_t samplerate, size_t framesize, size_t buffersize);
